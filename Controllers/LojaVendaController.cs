...
{
    public class LojaVendaController : Controller
    {
        private readonly ApplicationDbContext _context;

        public LojaVendaController(ApplicationDbContext context)
        {
            _context = context;
        }

        //GET: LojaVendas/Search
        public async Task<IActionResult> LojaVenda(DateTime? dataInicio, DateTime? dataFim)
        {
